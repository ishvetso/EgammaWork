...
//gPad->SetGrid();
  ...
  TGraph * gr2 =  graph_ROC("relisoWithEA_CITK_", 10000, 0., 10.);
  TGraph * gr3 =  graph_ROC("relisoWithEA_PUPPI", 10000, 0., 10.);
  TGraph * gr4 =  graph_ROC("relisoWithEA_pf", 10000, 0., 10.);
  ...
  leg->AddEntry(gr2, "relisoWithEA_CITK_","l");
  leg->AddEntry(gr3, "relisoWithEA_PUPPI","l");
  leg->AddEntry(gr4, "relisoWithEA_pf","l");
