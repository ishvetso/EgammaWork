...
config.General.requestName = 'Electron-Isolation_CITK_validation_DY_miniAOD_bugfixed'
...
config.Data.publishDataName = 'Electron-Isolation_CITK_validation_DY_miniAOD_bugfixed'
