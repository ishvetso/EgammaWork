...
config.General.requestName = 'Electron-Isolation_CITK_validation_ttbar_AOD_23June2015'
...
config.Data.publishDataName = 'Electron-Isolation_CITK_validation_ttbar_AOD_23June2015'
