...
config.General.requestName = 'Electron-Isolation_CITK_validation_ttbar_AOD_bugfixed'
...
config.Data.publishDataName = 'Electron-Isolation_CITK_validation_ttbar_AOD_bugfixed'
